    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.btnSubmit).setOnClickListener {
            ...
            if (photoFile != null) {
                ...
                Toast.makeText(requireContext(), "Successfully post a picture!", Toast.LENGTH_SHORT).show()
            } else {
    ...
    fun submitPost(description: String, user: ParseUser, photoFile: File) {
        ...
        post.saveInBackground { exception ->
            if (exception != null) {
                ...
                Toast.makeText(requireContext(), "Saving post error!", Toast.LENGTH_SHORT).show()
            } else {
                Log.i(MainActivity.TAG, "Successfully saved post")
                Toast.makeText(requireContext(), "Successfully post on Parstagram!", Toast.LENGTH_SHORT)
                    .show()
                // TODO: Reset the EditText field to be empty
                etDescription.findViewById<EditText>(R.id.etDescription).setText("")
                // TODO: Reset the ImageView to empty
                ivPreview.findViewById<ImageView>(R.id.ivPicture).setImageResource(android.R.color.transparent)
            }
        }
    }
